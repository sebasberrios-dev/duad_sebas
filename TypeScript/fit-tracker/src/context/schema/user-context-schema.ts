...
const exerciseStorageSchema: z.ZodType<Exercise> = z.object({
  id: z.number(),
...
const routineStorageSchema: z.ZodType<Routine> = z.object({
  id: z.number(),
...
export const userStorageSchema: z.ZodType<User> = z.object({
  id: z.number(),
  name: z.string(),
  age: z.number(),
  email: z.string(),
...
export const coachStorageSchema: z.ZodType<Coach> = z.object({
  id: z.number(),
  name: z.string(),
  age: z.number(),
  email: z.string(),
...
export const adminStorageSchema: z.ZodType<Admin> = z.object({
  id: z.number(),
  name: z.string(),
  age: z.number(),
  email: z.string(),
