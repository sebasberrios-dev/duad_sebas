...
export default function Catalog() {
    ...
    const availableExternalExercises = externalExercises.filter((api) => !localExercises.some((local) => local.exerciseName.toLowerCase() === api.exerciseName.toLowerCase()));
    ...
    return (_jsxs("div", { className: "p-8 w-full h-full mt-7 animate-slide-up-fade", children: [_jsxs("div", { className: "flex flex-row justify-center items-center gap-4", children: [_jsx(SelectInput, { id: "category-filter", value: selectedCategory, onChange: handleCategoryChange, options: categoryOptions, placeholder: "Selecciona una categor\u00EDa", className: "bg-gray-900 border-none w-56" }), selectedCategory === "Fuerza" && (_jsx(SelectInput, { id: "muscle-filter", value: selectedMuscle, onChange: handleMuscleChange, options: muscleOptions, placeholder: "Selecciona un m\u00FAsculo", className: "bg-gray-900 border-none w-56" })), _jsx(BigTitle, { className: "text-center", children: "Cat\u00E1logo de ejercicios" })] }), isAdminUser && availableExternalExercises.length > 0 && (_jsx("div", { className: "flex justify-start ml-26 mt-6", children: _jsx(Button, { type: "button", onClick: handleGenerateReport, className: "w-auto px-7 py-3  mt-0", children: "Generar reporte" }) })), _jsx("div", { className: "flex flex-col mt-6", children: _jsx(ExercisesCatalogField, { exercises: filteredLocalExercises }) }), isAdminUser && (_jsxs("div", { className: "flex flex-col mt-14", children: [_jsx(BigTitle, { className: "text-xl ml-26 self-start", children: "API Exercises" }), _jsx(ExercisesCatalogField, { exercises: availableExternalExercises, error: error, loading: loading, onAdd: handleAddExternalExercise })] }))] }));
}
